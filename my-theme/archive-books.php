...
<div class="container">
	<div class="row">
		...
		<?php
			...
			<p><b>Автор:</b> <?php echo get_post_meta($post->ID, 'meta1_author', true); ?></p>
			<p><b>Жанр:</b> <?php echo get_post_meta($post->ID, 'meta1_genre', true); ?></p>
			<p><b>Год:</b> <?php echo get_post_meta($post->ID, 'meta1_year', true); ?></p>
			<div class="excerpt">
